...
### Before the maintext
Currently, I am searching for suitable Phd Program. My research interests include: Maching Learning and statistic methods (e.g., MLE, variational inference, sampling method, etc.), Operational Research theory (both convex and non-convex cases, e.g., GD, SGD, SAGA, SVRG, interior point method, etc.), Bayesian Theorem/Inference/Optimization/Network. 
